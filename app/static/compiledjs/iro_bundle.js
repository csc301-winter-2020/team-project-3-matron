(function (factory) {
  typeof define === 'function' && define.amd ? define(['core-js/modules/es.symbol', 'core-js/modules/es.symbol.description', 'core-js/modules/es.symbol.iterator', 'core-js/modules/es.array.concat', 'core-js/modules/es.array.fill', 'core-js/modules/es.array.filter', 'core-js/modules/es.array.for-each', 'core-js/modules/es.array.index-of', 'core-js/modules/es.array.iterator', 'core-js/modules/es.array.map', 'core-js/modules/es.array.slice', 'core-js/modules/es.array.splice', 'core-js/modules/es.object.assign', 'core-js/modules/es.object.to-string', 'core-js/modules/es.promise', 'core-js/modules/es.regexp.constructor', 'core-js/modules/es.regexp.exec', 'core-js/modules/es.regexp.to-string', 'core-js/modules/es.string.iterator', 'core-js/modules/es.string.pad-start', 'core-js/modules/es.string.replace', 'core-js/modules/es.string.search', 'core-js/modules/es.string.sub', 'core-js/modules/web.dom-collections.for-each', 'core-js/modules/web.dom-collections.iterator'], factory) :
  factory();
}((function () { 'use strict';
