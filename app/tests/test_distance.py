...
class DistanceFunctionTest(unittest.TestCase):
    ...
    def test_dist_from_start(self):
        ...
        self.assertEqual(find_dist_from_start(test_go2, 'A'), output_2, "Invalid output")
    ...
    def test_find_dist_from_start(self):
        ...
        self.assertEqual(find_all_room_distances(test_go1), output_1, "Invalid output")
        self.assertEqual(find_all_room_distances(test_go2), output_2, "Invalid output")
