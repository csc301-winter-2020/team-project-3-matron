...
two_rooms_disconnected_json = {'nodes': [
...
two_rooms_one_hallway_node_json = {'nodes': [
    {'data': {'label': 'r1', 'type': 'room', 'id': 'r1'}, 'position': {'x': 370, 'y': 425}, 'group': 'nodes',
     'removed': False, 'selected': False, 'selectable': False, 'locked': False, 'grabbable': True, 'pannable': False,
     'classes': ''},
...
two_rooms_many_hallway_nodes_json = {'nodes': [
...
three_rooms_many_hall_ways_nodes_json = {'nodes': [
    ...
    {'data': {'id': 'e-A-hn1', 'label': '', 'source': 'A', 'target': 'hn1'}, 'position': {'x': 0, 'y': 0},
     'group': 'edges', 'removed': False, 'selected': False, 'selectable': True, 'locked': False, 'grabbable': True,
     'pannable': True, 'classes': ''},
    {'data': {'id': 'e-A-B', 'label': '', 'source': 'A', 'target': 'B'}, 'position': {'x': 0, 'y': 0}, 'group': 'edges',
    ...
    {'data': {'id': 'e-A-hn2', 'label': '', 'source': 'A', 'target': 'hn2'}, 'position': {'x': 0, 'y': 0},
     'group': 'edges', 'removed': False, 'selected': False, 'selectable': True, 'locked': False, 'grabbable': True,
     'pannable': True, 'classes': ''},
    {'data': {'id': 'e-B-C', 'label': '', 'source': 'B', 'target': 'C'}, 'position': {'x': 0, 'y': 0}, 'group': 'edges',
     'removed': False, 'selected': False, 'selectable': True, 'locked': False, 'grabbable': True, 'pannable': True,
     'classes': ''}]}
